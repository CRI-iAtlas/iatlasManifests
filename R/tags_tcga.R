tags_tcga <- function() {
  ...
  new_tags <- data.frame(
    "name" = c("gender", "female", "male",
               "race", "na_race", "white_race", "black_or_african_american_race",
    ...
    "short_display" = c("gender", "Female", "Male",
                        "race", "Not available", "White", "Black or African American",
    ...
    "color" = c(NA_character_, "#D41159", "#170ec4",
                NA_character_, "#868A88", "#377eb8", "#ff7f00", "#4daf4a", "#984ea3", "#e41a1c",
                NA_character_, "#868A88", "#377eb8", "#ff7f00"),
    "description"= c("Patient gender" , "Patient is female", "Patient is male",
                     "Race of the patient", "Race of the patient not available", "Race of the patient is White", "Race of the patient is Black or African American",
    ...
    "tag_type" = c("parent_group","group", "group", "parent_group", "group", "group", "group", "parent_group", "group", "group", "parent_group", "group", "group", "group")
  ) %>%
    dplyr::mutate(
      "id" = uuid::UUIDgenerate(n = dplyr::n()),
      "Component" = "tags"
